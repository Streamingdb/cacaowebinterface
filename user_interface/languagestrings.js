...
langstrings['en']['searchhints'] = '<small>Search for Movies, TV shows, Anime or paste a link<br>... or <a href="http://cacaoweb.org/makemoney.html">make money</a> !</small>';
...
langstrings['it']['ftpuploaddescr'] = "<p>Upload your files on ftpupload.cacaoweb.org with an ftp client (like filezilla). Use your cacaoweb username and password to authenticate.</p><p>It can take up to a few hours for the files to appear in \"My Uploads\". Once it's done you get the cacaoweb link for the file and upload the metadata (title, type, episode, etc.). This will ensure the file appears in the search engine.</p><br>";
...
langstrings['pl']['ftpuploaddescr'] = "<p>Upload your files on ftpupload.cacaoweb.org with an ftp client (like filezilla). Use your cacaoweb username and password to authenticate.</p><p>It can take up to a few hours for the files to appear in \"My Uploads\". Once it's done you get the cacaoweb link for the file and upload the metadata (title, type, episode, etc.). This will ensure the file appears in the search engine.</p><br>";
