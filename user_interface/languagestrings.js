...
langstrings['en']['smallyear'] = '<small>Year</small>';
...
langstrings['en']['backmainpage'] = 'back';
...
langstrings['en']['natnotp2pfriendly'] = "Your router is not compatible, you might experience slow speed, more information <a href='http://forum.cacaoweb.org/index.php?topic=33.0' target=\"_newtab\">here</a>. Please contact your customer service.";
...
langstrings['en']['mymoney'] = "<a href=\"http://user.cacaoweb.org\">Click here</a> to manage your account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Buy</a>";
...
langstrings['en']['howtomakemoney'] = "How to make money?";
langstrings['en']['smallfilelink'] = "<small>cacaoweb link</small>";
langstrings['en']['ftpuploaddescr'] = "<p>Upload your files on ftpupload.cacaoweb.org with an ftp client (like filezilla). Use your cacaoweb username and password to authenticate.</p><p>It can take up to a few hours for the files to appear in \"My Uploads\". Once it's done you get the cacaoweb link for the file and upload the metadata (title, type, episode, etc.). This will ensure the file appears in the search engine.</p><br>";
...
langstrings['en']['mostwatched'] = "Most watched:";
langstrings['en']['youmightlike'] = "You might also like:";
...
langstrings['fr']['smallyear'] = '<small>Année</small>';
...
langstrings['fr']['backmainpage'] = 'retour';
...
langstrings['fr']['natnotp2pfriendly'] = "Votre routeur n'est pas compatible, voir <a href='http://forum.cacaoweb.org/index.php?topic=33.0' target=\"_newtab\">ici</a>. Merci de contacter votre service client.";
...
langstrings['fr']['welcome'] = "Bienvenue ";
langstrings['fr']['mymoney'] = "<a href=\"http://user.cacaoweb.org\">Cliquez ici</a> pour gérer votre compte. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Acheter</a>";
...
langstrings['fr']['mostwatched'] = "Les plus regardés:";
langstrings['fr']['youmightlike'] = "Vous aimerez aussi:";
...
langstrings['it']['mymoney'] = "<a href=\"http://user.cacaoweb.org\">Click here</a> to manage your account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Acquistare crediti</a>";
...
langstrings['it']['mostwatched'] = "Most watched:";
langstrings['it']['youmightlike'] = "You might also like:";
langstrings['it']['en'] = "inglese";
langstrings['it']['fr'] = "francese";
langstrings['it']['it'] = "italiano";
langstrings['it']['es'] = "spagnolo";
langstrings['it']['pt'] = "portoghese";
langstrings['it']['de'] = "tedesco";
langstrings['it']['hu'] = "ungherese";
langstrings['it']['pl'] = "polacco";
langstrings['it']['ru'] = "russo";
langstrings['it']['ar'] = "arabo";
langstrings['it']['cn'] = "cinese";
langstrings['it']['hi'] = "indiano";
langstrings['it']['jp'] = "giapponese";
langstrings['it']['vn'] = "vietnamita";
...
langstrings['pl']['mymoney'] = "<a href=\"http://user.cacaoweb.org\">Click here</a> to manage your account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Zakupić</a>";
langstrings['pl']['buywithpaypal'] = "Kup z Paypal";
langstrings['pl']['numberofcreditstobuy'] = "Liczba kredytów do zakupienia:";
langstrings['pl']['name'] = "Login";
...
langstrings['pl']['ftpuploaddescr'] = "<p>Wyślij swoje pliki na ftpupload.cacaoweb.org z klienta ftp (np. filezilla). Użyj loginu i hasła z cacaoweb do autoryzacji.</p><p> Może to zająć kilka dodzin, zanim pliki pojawią się w zakładce \"Wysłane\". Po zakończeniu otrzymasz link cacaoweb link i będziesz mógł nadać m.in. tytuł, typ oraz epizod, co zaowocuję pojawieniuem linku w wyszukiwarce.</p><br>";
...
langstrings['pl']['mostwatched'] = "Most watched:";
langstrings['pl']['youmightlike'] = "You might also like:";
...
langstrings['es']['backmainpage'] = 'volver';
...
langstrings['es']['mymoney'] = "<a href=\"http://user.cacaoweb.org\">Click here</a> to manage your account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>¡Añade créditos!</a>";
...
langstrings['es']['makemoney'] = "Gana dinero";
langstrings['es']['howtomakemoney'] = "¿Cómo ganar dinero?";
langstrings['es']['smallfilelink'] = "<small>enlace de cacaoweb</small>";
langstrings['es']['ftpuploaddescr'] = "<p>Sube tus archivos a ftpupload.cacaoweb.org con un cliente ftp (como Filezilla). Usa tu nombre de usuario y contraseña de cacaoweb para acceder.</p><p>Puede tardar unas horas hasta que los archivos aparezcan en \"Mis subidas\". Una vez hecho, obtienes un enlace de cacaoweb para el archivo y sube los metadatos (título, tipo, episodio, etc.). Así, tu archivo aparecerá en las búsquedas.</p><br>";
...
langstrings['es']['mostwatched'] = "Most watched:";
langstrings['es']['youmightlike'] = "You might also like:";
