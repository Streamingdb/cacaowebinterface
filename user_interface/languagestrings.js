...
langstrings['en']['mymoney'] = "You have {1} credits in your account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Buy</a>";
...
langstrings['fr']['mymoney'] = "Vous avez {1} crédits. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Acheter</a>";
...
langstrings['it']['mymoney'] = "Hai {1} crediti nel tuo account. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Acquistare crediti</a>";
...
langstrings['pl']['mymoney'] = "Posiadasz {1} kredytów na koncie. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>Zakupić</a>";
...
langstrings['es']['mymoney'] = "Tienes {1} créditos en tu cuenta. <a href='javascript:showcreditsform();' data-icon='€' class='button orange serif round glass'>¡Añade créditos!</a>";
