package org.fasex.preloader
{
	...
	public class LightRayMultiColorLine extends Sprite
	{
		private var ray:LightRay;
		private var i:int = 0;
		private var colorArr:Array = [0xFF0000,0xFF9900,0xFFFF00,0x00FF00,0x00FFFF,0x0000FF,0xFF00FF];
		private var colorTHRxArr:Array = [0x001100,0x001100,-0x110000,0x000011,-0x001100,0x110000,-0x000011];
		...
		public function LightRayMultiColorLine()
		{
			super();
		}
		public function build():void{
			...
			this.percent = 11;
			//
			this.ray = new LightRay(LightRay.TYPE_LINE,8,36);
			this.addChild(ray);
		...
		private function run():void{
			...
			for(var i:int=0;i<pointSum;i++){
				var _point:Object = {x:i*4-75,y:0};
				_pArr.push(_point);
			}
			ray.buildByNoRoArray(_pArr,-1);
		}
