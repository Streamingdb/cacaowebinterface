...
langstrings['en']['mymoney'] = "You have {1} credits in your account. <a href='javascript:showcreditsform();'>Click here to add credits.</a>";
...
langstrings['fr']['mymoney'] = "Vous avez {1} crédits. <a href='javascript:showcreditsform();'>Cliquez ici pour ajouter des crédits.</a>";
...
langstrings['it']['mymoney'] = "Hai {1} crediti nel tuo account. <a href='javascript:showcreditsform();'>Clicca quì per acquistare crediti.</a>";
...
langstrings['pl']['mymoney'] = "Posiadasz {1} kredytów na koncie. <a href='javascript:showcreditsform();'>Kliknij tutaj aby zakupić kredyty.</a>";
